...
if menu == "Комплексный потенциал течения":
    ...
    **Преобразование Жуковского**
    ...
    r"""
        ...
        | Большая полуось       |Размер сетки      |       $p=1$      |        $p=2$     |        $p=3$     |
        |-----------------------|------------------|------------------|------------------|------------------|
        | $R = 0.175$           |    $14594$       |  $9.888*10^{-6}$ | $-2.986*10^{-6}$ | $-2.234*10^{-6}$ |
        | $R = 0.225$           |    $16635$       |  $1.078*10^{-5}$ | $-1.313*10^{-6}$ | $-8.002*10^{-7}$ |
        | $R = 0.275$           |    $18929$       |  $2.253*10^{-5}$ |  $2.096*10^{-6}$ |  $1.393*10^{-6}$ |
    ...
    r"""
        ...
        |------------------------------------|--------------------|--------------------|--------------|
        | $14594$                            |        $14594$     |      $57116$       |   $127566$   |
        | $16635$                            |        $16635$     |      $65072$       |   $145311$   |
        | $18929$                            |        $18929$     |      $74032$       |   $165309$   |
