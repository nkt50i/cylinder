...
if menu == "Комплексный потенциал течения":
    ...
    r"""
        ...
        | Полуоси эллипса          |Размер сетки      |       $p=1$        |        $p=2$       |        $p=3$       |
        |--------------------------|------------------|--------------------|--------------------|--------------------|
        | $R = 0.175, r = 0.125$   |    $14594$       |  $9.88850*10^{-6}$ | $-2.98645*10^{-6}$ | $-2.23483*10^{-6}$ |
        | $R = 0.225, r = 0.125$   |    $16635$       |  $1.07842*10^{-5}$ | $-1.31345*10^{-6}$ | $-8.00204*10^{-7}$ |
        | $R = 0.275, r = 0.125$   |    $18929$       |  $2.25365*10^{-5}$ |  $2.09678*10^{-6}$ |  $1.39354*10^{-6}$ |
    ...
    ##### Число искомых дискретных значений
        ...
        |------------------------------------|--------------------|--------------------|--------------|
        | $R = 0.175, r = 0.125$             |        $14594$     |      $57116$       |   $127566$   |
        | $R = 0.225, r = 0.125$             |        $16635$     |      $65072$       |   $145311$   |
        | $R = 0.275, r = 0.125$             |        $18929$     |      $74032$       |   $165309$   |
