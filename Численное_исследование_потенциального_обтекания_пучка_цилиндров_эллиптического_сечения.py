...
participants = [
    ...
    {"name": "Коврижных Анастасия", "photo": "3.jpg", "role": "Постановка задачи, геометрическая модель, математическая модель, конечно-элементная аппроксимация задачи"},
